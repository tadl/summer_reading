...
load_functions = function() {
  ...
  $('.self_week_report').change(function(){
    var participant_and_week = $(this).val();
    var participant_id = participant_and_week.split('-')[0]
    var week_id = participant_and_week.split('-')[1]
    if($(this).is(":checked")){
      $.post('/main/self_report_week.json',{participant_id: participant_id, week_id: week_id, week_value: 'true'})
    }else{
      $.post('/main/self_report_week.json',{participant_id: participant_id, week_id: week_id, week_value: 'false'})
    }
  });
